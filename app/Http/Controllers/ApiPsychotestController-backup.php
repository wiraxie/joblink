		...
		class ApiPsychotestController extends \crocodicstudio\crudbooster\controllers\ApiController {
		    ...
		    public function hook_before(&$postdata) 
			{
				...
				elseif($checkregid2 != '[]')
				{
					...
					'{".'"type":"'."', psycho_result_score.ptype, '".'",'."',
					'".'"correct_answers":"'."', psycho_result_score.correct_answers, '".'",'."',
					'".'"score":"'."', psycho_result_score.score, '".'"}'."'
					SEPARATOR ','), ']') from psycho_result_score) as details
					FROM psycho_result
					WHERE psycho_result.regid=".id;
