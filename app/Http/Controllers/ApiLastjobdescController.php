<?php namespace App\Http\Controllers;
		...
		class ApiLastjobdescController extends \crocodicstudio\crudbooster\controllers\ApiController {

		    function __construct() {    
				$this->table       = "personal_factors";        
				$this->permalink   = "lastjobdesc";    
		    ...
		    public function hook_before(&$postdata) {
				...
				else
				{
					...
					$returndata = DB::table('personal_factors')->select('id' ,'lastjob', 'created_at')->where('regid', Request::get('id'))->get();
